...
export const metadata = {
  title: "InsurAI — Asistent pentru asigurări",
  description:
    "Asistent conversațional care răspunde clar la întrebări despre asigurări de sănătate, viață, pensii, auto și locuință.",
};
